...
export default [
  ...
  {
    path: '/',
    component: ComponentCreator('/', 'da6'),
    routes: [
      {
        path: '/',
      ...
      {
        path: '/2Java',
        component: ComponentCreator('/2Java', 'd09'),
        exact: true,
        sidebar: "myAutogeneratedSidebar"
      },
      {
      ...
      {
        path: '/2python',
        component: ComponentCreator('/2python', 'b6e'),
        exact: true,
        sidebar: "myAutogeneratedSidebar"
      },
      {
      ...
      {
        path: '/docusaurus',
        component: ComponentCreator('/docusaurus', 'e64'),
        exact: true,
        sidebar: "myAutogeneratedSidebar"
      },
      {
      ...
      {
        path: '/Javascript',
        component: ComponentCreator('/Javascript', 'd9f'),
        exact: true,
        sidebar: "myAutogeneratedSidebar"
      },
      {
        path: '/PlayWright',
        component: ComponentCreator('/PlayWright', '81e'),
        exact: true,
        sidebar: "myAutogeneratedSidebar"
      },
      {
      ...
      {
        path: '/TypeScript',
        component: ComponentCreator('/TypeScript', 'e14'),
        exact: true,
        sidebar: "myAutogeneratedSidebar"
      },
      {
